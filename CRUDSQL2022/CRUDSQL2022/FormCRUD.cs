...
namespace CRUDSQL2022
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Aluno\\Desktop\\CRUDSQL2022\\CRUDSQL2022\\DbPessoa.mdf;Integrated Security=True");
        public FormCRUD()
        {
            InitializeComponent();
        }
        ...
        {
            String str = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Aluno\\Desktop\\CRUDSQL2022\\CRUDSQL2022\\DbPessoa.mdf;Integrated Security=True";
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            CarregaDGV();
            MessageBox.Show("Pessoa cadastrada com sucesso de cria!", "Cadastro de Pessoas");
            txtCPF.Text = "";
            txtNome.Text = "";
            txtEndereco.Text = "";
            txtCelular.Text = "";
